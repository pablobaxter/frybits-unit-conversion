...
class TimeUnitSample {
    ...
    public static void main(String... args) {
        ...
        System.out.println();
        System.out.println("Nanos to nanos: " + TimeUnit.NANOSECOND.toNanoseconds(unit));
        System.out.println("Nanos to micros: " + TimeUnit.NANOSECOND.toMicroseconds(unit));
        System.out.println("Nanos to millis: " + TimeUnit.NANOSECOND.toMilliseconds(unit));
        System.out.println("Nanos to seconds: " + TimeUnit.NANOSECOND.toSeconds(unit));
        System.out.println("Nanos to minutes: " + TimeUnit.NANOSECOND.toMinutes(unit));
        System.out.println("Nanos to hours: " + TimeUnit.NANOSECOND.toHours(unit));
        System.out.println("Nanos to days: " + TimeUnit.NANOSECOND.toDays(unit));
        System.out.println();
